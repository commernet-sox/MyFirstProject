...
namespace CPC.TaskManager.Plugins.TypeHandlers
{
    ...
    {
        public override bool CanHandle(object value) => value is byte[];
        ...
        private bool HasBinaryContent(string content) => content.Take(1024).Any(ch => char.IsControl(ch) && ch != '\r' && ch != '\n' && ch != '\t');
    }
}
