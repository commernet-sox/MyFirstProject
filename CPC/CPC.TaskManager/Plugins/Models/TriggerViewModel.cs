...
namespace CPC.TaskManager.Plugins
{
    ...
    public class CronTriggerViewModel : IHasValidation
    {
        ...
        public static CronTriggerViewModel FromTrigger(ICronTrigger trigger) => new CronTriggerViewModel()
        {
            Expression = trigger.CronExpressionString,
            TimeZone = trigger.TimeZone.Id,
        };

        public void Apply(TriggerBuilder builder, TriggerPropertiesViewModel model) => builder.WithCronSchedule(Expression, x =>
                                                                                     {
    ...
    public class SimpleTriggerViewModel : IHasValidation
    {
        ...
        public void Apply(TriggerBuilder builder, TriggerPropertiesViewModel model) => builder.WithSimpleSchedule(x =>
                                                                                     {
    ...
    public class DailyTriggerViewModel : IHasValidation
    {
        ...
        public void Apply(TriggerBuilder builder, TriggerPropertiesViewModel model) => builder.WithDailyTimeIntervalSchedule(x =>
                                                                                     {
                                                                                         if (!string.IsNullOrEmpty(TimeZone))
                                                                                         {
                                                                                             x.InTimeZone(TimeZoneInfo.FindSystemTimeZoneById(TimeZone));
    ...
    public class CalendarTriggerViewModel : IHasValidation
    {
        ...
        public void Validate(ICollection<ValidationError> errors) => ModelValidator.ValidateObject(this, errors, nameof(TriggerViewModel.Trigger), nameof(TriggerPropertiesViewModel.Calendar));

        public static CalendarTriggerViewModel FromTrigger(ICalendarIntervalTrigger trigger) => new CalendarTriggerViewModel()
        {
            RepeatInterval = trigger.RepeatInterval,
            RepeatUnit = trigger.RepeatIntervalUnit,
        ...
        public void Apply(TriggerBuilder builder, TriggerPropertiesViewModel model) => builder.WithCalendarIntervalSchedule(x =>
                                                                                     {
                                                                                         if (!string.IsNullOrEmpty(TimeZone))
                                                                                         {
                                                                                             x.InTimeZone(TimeZoneInfo.FindSystemTimeZoneById(TimeZone));
