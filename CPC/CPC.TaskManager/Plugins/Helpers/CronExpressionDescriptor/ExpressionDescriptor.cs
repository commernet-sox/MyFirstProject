...
namespace CPC.TaskManager.Plugins
{
    ...
    public class ExpressionDescriptor
    {
        ...
        private readonly string[] _hourFormat = new string[] { "ru", "uk", "de", "it", "tr", "pl", "ro", "da", "sl" };
        ...
        public ExpressionDescriptor(string expression, Options options)
        {
            ...
            {
                // 24HourTimeFormat not specified, default based on _24hourTimeFormatLocales
                _use24HourTimeFormat = _hourFormat.Contains(_culture.TwoLetterISOLanguageName);
            }
        }
        ...
        protected string FormatTime(string hourExpression, string minuteExpression) => FormatTime(hourExpression, minuteExpression, string.Empty);
        ...
        protected string GetString(string resourceName) => Resources.GetString(resourceName);
        ...
        /// <param name="expression">The cron expression string</param>
        /// <returns>The cron expression description</returns>
        public static string GetDescription(string expression) => GetDescription(expression, new Options());
        ...
        public static string GetDescription(string expression, Options options)
        {
            ...
            return descripter.GetDescription(DescriptionType.Full);
        }
        #endregion
    }
