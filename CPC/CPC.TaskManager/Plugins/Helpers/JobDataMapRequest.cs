...
namespace CPC.TaskManager.Plugins
{
    internal static class JobDataMapRequest
    {
        ...
        public static async Task<Dictionary<string, object>[]> GetJobDataMapForm(this HttpRequest request, bool includeRowIndex = true) => await GetJobDataMapForm(await request.GetFormData(), includeRowIndex);
