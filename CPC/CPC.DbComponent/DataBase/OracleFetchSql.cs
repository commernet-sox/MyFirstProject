...
{
    public class OracleFetchSql : FetchSql
    {
        // Fields
        ...
        // Methods
        public OracleFetchSql(IDbUtil dbUtil) => _dbUtil = dbUtil;
        ...
        private string GetInterCurrentCondition(DataRowView drv, string[] obj)
        {
            var table = drv.Row.Table;
            var tableName = table.TableName;
        ...
        private string GetMasterKeyCondition(DataRowView drv)
        {
            var table = drv.Row.Table;
            var tableName = table.TableName;
