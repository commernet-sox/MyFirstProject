    ...
    public static class DbSqlExtensions
    {
        ...
        public static void SqlQuery(this DatabaseFacade databaseFacade, string sql, Action<SqlResult> handleResults, params object[] parameters)
        {
            ...
            using (concurrencyDetector.EnterCriticalSection())
            {
                ...
                using (var dbReader = rawSqlCommand.RelationalCommand.ExecuteReader(new RelationalCommandParameterObject(
        ...
        public static IList<T> SqlQuery<T>(this DatabaseFacade databaseFacade, string sql, params object[] parameters)
        {
            IList<T> list = new List<T>();
            databaseFacade.SqlQuery(sql, handle =>
            {
                list = handle.ReadToList<T>();
            }, parameters);
            return list;
        }
        #endregion
