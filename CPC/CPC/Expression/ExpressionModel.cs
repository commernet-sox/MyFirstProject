...
namespace CPC
{
        ...
        where T : class
    {
        ...
        public ExpressionModel<T> Config(Expression<Func<T, object>> columnName, Expression<Func<T, bool>> expression) => Config(columnName.GetPropertyName(), expression);
        ...
        public ExpressionModel<T> Config(Expression<Func<T, object>> columnName, ExpressionOperator @operator, string fieldName = "") => Config(columnName.GetPropertyName(), @operator, fieldName);
        ...
        public ExpressionModel<T> ConfigIgnore(Expression<Func<T, object>> columnName) => ConfigIgnore(columnName.GetPropertyName());
