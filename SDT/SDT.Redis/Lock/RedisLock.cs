...
namespace SDT.Redis.Lock
{
    ...
    public class RedisLock : IDistributedLock
    {
        ...
        private static readonly string UnlockScript = EmbeddedResourceLoader.GetEmbeddedResource("SDT.Redis.Lock.Lua.Unlock.lua");

        private static readonly string ExtendIfMatchingValueScript = EmbeddedResourceLoader.GetEmbeddedResource("SDT.Redis.Lock.Lua.Extend.lua");
