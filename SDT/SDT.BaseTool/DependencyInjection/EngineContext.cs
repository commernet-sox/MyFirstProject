...
namespace SDT.BaseTool
{
    public static class EngineContext
    {
        ...
        public static IEngine Initialize(bool forceRecreate, EngineSettings settings = null, IServiceContext service = null)
        {
            return Initialize(service, settings, forceRecreate);
        }
