...
namespace StudyExtend.RequestProvider
{
    public class RequestProvider : IRequestProvider
    {
        ...
        public RequestProvider()
        {
            ...
            NullValueHandling = NullValueHandling.Include,//必须包含
        };
        ...
        public async Task<TResult> PostAsync<TData, TResult>(string uri, TData data, Stream stream, string typeName, string token = "", string header = "")
        {
            HttpClient httpClient = CreateHttpClient(token);
            ...
            multipartContent.Add(streamContent, "File", "File");
            multipartContent.Add(stringContent, typeName);
