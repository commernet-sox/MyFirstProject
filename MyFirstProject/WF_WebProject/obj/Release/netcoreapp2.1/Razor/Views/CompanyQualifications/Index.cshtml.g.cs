#pragma checksum "C:\Users\FS\source\repos\MyFirstProject\WF_WebProject\Views\CompanyQualifications\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cb2b65bba46734d3e66ef93a83c8d5466b18392a"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cb2b65bba46734d3e66ef93a83c8d5466b18392a", @"/Views/CompanyQualifications/Index.cshtml")]
...
#line hidden
         ...
         ");
                WriteLiteral(@"               }
                    ...
                    { data: ""QualificationLevel"", title: ""资质等级"", searchable: true, orderable: true");
                WriteLiteral(@", visible: true, width: ""100px"", responsivePriority: 2 },
                    ...
                    {
                        data: ""EndDate"", title: ""资质到期日期"", searchable: true, orde");
                WriteLiteral(@"rable: true, width: ""100px"", responsivePriority: 2,
                        render: function (val, type, row) {
                            if (val == null) {
                                return """";
                            }
                ...
                WriteLiteral(@"= null) {
                    ...
                    {
                        data: ""SafetyLicenseEndTime"", title: ""安许证到期日期"", searchable: true, orderable: true, width: ""100px"", responsivePriority: 2 ,
                        render: function (val, type, row) {
                            if (val == null) {
                                return """";
                            }
            ...
            $('#Search').click(function () {
                ...
                $.each(items, function (index, obj) {
                    ...
                    if (val === null)
                        val = '';
                    var index = $('#example1').DataTable().columns(");
                WriteLiteral(@").dataSrc().indexOf(name);
        ...
        function Detail(Id) {
            ...
            text += ""安全生产许可证编号 : "" + (rows[0].SafetyLicense");
                WriteLiteral(@"No == null ? ""无"" : rows[0].SafetyLicenseNo) + ""</br>"";
            ...
            editor = new $.fn.dataTable.Editor({
                        ...
                        ajax: {
                            edit: {
                                url: '");
                EndContext();
                BeginContext(22265, 43, false);
#line 415 "C:\Users\FS\source\repos\MyFirstProject\WF_WebProject\Views\CompanyQualifications\Index.cshtml"
                                 Write(Url.Action("Edit", "CompanyQualifications"));

#line default
#line hidden
                EndContext();
                BeginContext(22308, 957, true);
                WriteLiteral(@"',
                                type: 'POST',
                                dataType: 'json',
                                data: { ""Id"": rowId+'' }
