#pragma checksum "C:\Users\FS\source\repos\MyFirstProject\WF_WebProject\Views\CompanyInfo\AllIndex.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "55a18226437f67c286b97de2c8ceb6c661d14b7a"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"55a18226437f67c286b97de2c8ceb6c661d14b7a", @"/Views/CompanyInfo/AllIndex.cshtml")]
...
");
  ...
  ");
    ...
    <div class=""modal fade"" id=""issueTableCode"" tab");
        ...
        $(document).ready(function () {
            ...
            table = $('#example1').DataTable({
                ...
                ajax: {
                    url: """);
                EndContext();
                BeginContext(17307, 47, false);
#line 346 "C:\Users\FS\source\repos\MyFirstProject\WF_WebProject\Views\CompanyInfo\AllIndex.cshtml"
                     Write(Url.Action("CompanyAllPageData", "CompanyInfo"));

#line default
#line hidden
                EndContext();
                BeginContext(17354, 13024, true);
                WriteLiteral(@""",
                    type: ""post""
                },
                order: [[0, 'asc']],//一定要添加
                ...
                columns: [
                    { data: ""Id"", title: ""主键"", searchable: true, orderable: true, width: ""50px"",visible:false, responsivePriority: 1 },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            var title = ""<a href='javascript:void(0);' onclick='Detail("" + meta.row + "")' title='"" + row.Name + ""'>"" + row.Name.substring(0, 10) + ""..."" + ""</a>"";
                            return title;
                        }
                    },
                    { data: ""Industry"", title: ""行业"", searchable: true, orderable: true, width: ""100px"", responsivePriority: 1 },
      ");
                WriteLiteral(@"              { data: ""LegalPerson"", title: ""法定代表人"", searchable: true, orderable: true, width: ""100px"", responsivePriority: 1 },
                    ...
                    { data: ""Address"", title: ""办公地址"", searchable: true, orderable: true, vi");
                WriteLiteral(@"sible: false, width: ""100px"", responsivePriority: 1 },
                    ...
                    { data: ""PaidCapital"", title: ""实缴资本"", search");
                WriteLiteral(@"able: true, orderable: true, visible: false, width: ""100px"", responsivePriority: 1 },
                    ...
                    { dat");
                WriteLiteral(@"a: ""BusinessTerm"", title: ""营业期限"", searchable: true, orderable: true, visible: false, width: ""100px"", responsivePriority: 1 },
                    ...
                    { data: ""RegisterAddress"", title: ""注册地址"", searchable: true, orderable: true, visible: false, width: ""100p");
                WriteLiteral(@"x"", responsivePriority: 1 },
                    ...
                    { data: ""WebSite"", title: ""企业网址""");
                WriteLiteral(@", searchable: true, orderable: true, visible: false, width: ""100px"", responsivePriority: 1 },
                ...
                WriteLiteral(@"urn val;
                    ...
                    { data: ""Organi");
                WriteLiteral(@"zationCode1"", title: ""组织机构代码"", searchable: true, orderable: true, width: ""100px"", responsivePriority: 1 },
        ...
        function Detail(Id) {
            ...
            var text = ""办公地");
                WriteLiteral(@"址 : "" + (rows[0].Address == null ? ""无"" : rows[0].Address) + ""\n"";
            text += ""企业公示的地址 : "" + (rows[0].PublicAddress == null ? ""无"" : rows[0].PublicAddress) + ""\n"";
            text += ""企业公示的网址 : "" + (rows[0].PublicWebSite == null ? ""无"" : rows[0].PublicWebSite) + ""\n"";
            text += ""企业公示的邮箱 : "" + (rows[0].PublicEmail == null ? ""无"" : rows[0].PublicEmail) + ""\n"";
            text += ""经营范围 : "" + (rows[0].BusinessScope == null ? ""无"" : rows[0].BusinessScope) + ""\n"";
            text += ""实缴资本 : "" + (rows[0].PaidCapital == null ? ""无"" : rows[0].PaidCapital) + ""\n"";
            text += ""工商注册号 : "" + (rows[0].RegistrationNo == null ? ""无"" : rows[0].RegistrationNo) + ""\n"";
            text += ""纳税人识别号 : "" + (rows[0].IdentificationNumber == null ? ""无"" : rows[0].IdentificationNumber) + ""\n"";
            text += ""组织机构代码 : "" + (rows[0].OrganizationCode == null ? ""无"" : rows[0].OrganizationCode) + ""\n"";
            text += ""登记机关 : "" + (rows[0].RegistrationAuthority == null ? ""无"" : rows[0].RegistrationAuthor");
                WriteLiteral(@"ity) + ""\n"";
            text += ""营业期限 : "" + (rows[0].BusinessTerm == null ? ""无"" : rows[0].BusinessTerm) + ""\n"";
            text += ""纳税人资质 : "" + (rows[0].TaxpayerQualification == null ? ""无"" : rows[0].TaxpayerQualification) + ""\n"";
            text += ""人员规模 : "" + (rows[0].PersonnelSize == null ? ""无"" : rows[0].PersonnelSize) + ""\n"";
            text += ""参保人数 : "" + (rows[0].NumberInsured == null ? ""无"" : rows[0].NumberInsured) + ""\n"";
            text += ""曾用名 : "" + (rows[0].NameUsedBefore == null ? ""无"" : rows[0].NameUsedBefore) + ""\n"";
            text += ""英文名称 : "" + (rows[0].EnglishName == null ? ""无"" : rows[0].EnglishName) + ""\n"";
            text += ""注册地址 : "" + (rows[0].RegisterAddress == null ? ""无"" : rows[0].RegisterAddress) + ""\n"";

            text += ""经济类型 : "" + (rows[0].EconomicType == null ? ""无"" : rows[0].EconomicType) + ""\n"";
            text += ""邮箱 : "" + (rows[0].Email == null ? ""无"" : rows[0].Email) + ""\n"";
            text += ""企业网址 : "" + (rows[0].WebSite == null ? ""无"" : rows[0].WebSite) + """);
                WriteLiteral(@"\n"";
            text += ""资质联系地址 : "" + (rows[0].ContactAddress == null ? ""无"" : rows[0].ContactAddress) + ""\n"";
            text += ""邮编 : "" + (rows[0].ZipCode == null ? ""无"" : rows[0].ZipCode) + ""\n"";
            text += ""安全生产许可证编号 : "" + (rows[0].SafetyLicenseNo == null ? ""无"" : rows[0].SafetyLicenseNo) + ""\n"";
            text += ""发证机构 : "" + (rows[0].IssuingAuthority == null ? ""无"" : rows[0].IssuingAuthority) + ""\n"";
            ...
            editor = new $.fn.dataTable.Editor({
                        ...
                        ajax: {
                            edit: {
                                url: '");
                EndContext();
                BeginContext(30379, 33, false);
#line 497 "C:\Users\FS\source\repos\MyFirstProject\WF_WebProject\Views\CompanyInfo\AllIndex.cshtml"
                                 Write(Url.Action("Edit", "CompanyInfo"));

#line default
#line hidden
                EndContext();
                BeginContext(30412, 957, true);
                WriteLiteral(@"',
                                type: 'POST',
                                dataType: 'json',
                                data: { ""Id"": rowId+'' }
