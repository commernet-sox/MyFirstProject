#pragma checksum "C:\Users\FS\source\repos\MyFirstProject\WF_WebProject\Views\CompanyInfo\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "80975377191e6ecb6c32c656e46ca75d615a547c"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"80975377191e6ecb6c32c656e46ca75d615a547c", @"/Views/CompanyInfo/Index.cshtml")]
...
");
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            //    ");
                WriteLiteral(@"var title = $(this).text();
            ...
            table = $('#example1').DataTable({
                ...
                //    var _$this = this;
                //    var searchHTML = '<label><span");
                WriteLiteral(@">搜索:</span> <input type=""search"" placeholder=""请输入搜索内容"" aria-controls=""datatable1""></label>';
                //    //快捷操作的HTML DOM
    ...
    ");
                WriteLiteral("                url: \"");
                EndContext();
                BeginContext(11247, 37, false);
#line 241 "C:\Users\FS\source\repos\MyFirstProject\WF_WebProject\Views\CompanyInfo\Index.cshtml"
                     Write(Url.Action("PageData", "CompanyInfo"));

#line default
#line hidden
                EndContext();
                BeginContext(11284, 9596, true);
                WriteLiteral(@""",
                    type: ""post""
                },
                order: [[0, 'asc']],//一定要添加
                ...
                WriteLiteral(@"  }
                    ...
                    { data: ""PublicTel"", title: ""企业公示的联系电话（更多号码）"",  searchable:");
                WriteLiteral(@" true, orderable: true, width: ""100px"", responsivePriority: 2 },
                    ...
                    { data: ""BusinessStatus"", ");
                WriteLiteral(@"title: ""经营状态"",  searchable: true, orderable: true, width: ""100px"", responsivePriority: 2 },
    ...
    ");
            ...
            $('#Se");
                WriteLiteral(@"arch').click(function () {
       ...
       ");
        ...
        function Detail(Id) {
            ...
            text += ""纳税人识别号 : "" + (ro");
                WriteLiteral(@"ws[0].IdentificationNumber == null ? ""无"" : rows[0].IdentificationNumber) + ""</br>"";
            ...
            text += ""注册地址 : "" + (rows[0].RegisterAddres");
                WriteLiteral(@"s == null ? ""无"" : rows[0].RegisterAddress) + ""</br>"";
            ...
            editor = new $.fn.dataTable.Editor({
                        ...
                        ajax: {
                            edit: {
                                url: '");
                EndContext();
                BeginContext(20881, 33, false);
#line 368 "C:\Users\FS\source\repos\MyFirstProject\WF_WebProject\Views\CompanyInfo\Index.cshtml"
                                 Write(Url.Action("Edit", "CompanyInfo"));

#line default
#line hidden
                EndContext();
                BeginContext(20914, 957, true);
                WriteLiteral(@"',
                                type: 'POST',
                                dataType: 'json',
                                data: { ""Id"": rowId+'' }
