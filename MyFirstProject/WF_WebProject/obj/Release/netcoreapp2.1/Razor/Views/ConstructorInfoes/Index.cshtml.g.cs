#pragma checksum "C:\Users\FS\source\repos\MyFirstProject\WF_WebProject\Views\ConstructorInfoes\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "50bbb0cc03979f2e6a67604b4b9a846770247d38"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"50bbb0cc03979f2e6a67604b4b9a846770247d38", @"/Views/ConstructorInfoes/Index.cshtml")]
 ...
 ");
           ...
           ");
                ...
                ajax: {
                    url: """);
                EndContext();
                BeginContext(9626, 43, false);
#line 205 "C:\Users\FS\source\repos\MyFirstProject\WF_WebProject\Views\ConstructorInfoes\Index.cshtml"
                     Write(Url.Action("PageData", "ConstructorInfoes"));

#line default
#line hidden
                EndContext();
                BeginContext(9669, 4365, true);
                WriteLiteral(@""",
                    type: ""post""
                },
                order: [[0, 'asc']],//一定要添加
                ...
                columns: [
                    ...
                    { data: ""Province"", title: ""省份"", searchable: true, orderable: false, visible: false, width: ""100px"", responsivePriority: 1 },
                    {
                        data: ""CompanyName"", title: ""企业名称"", searchable: true, orderable: true, width: ""100px"", responsivePriority: 1,
                        render: function (data, type, row, meta) {
                            var title = ""<a href='javascript:void(0);' onclick='Detail("" + meta.row + "")' title='"" + row.CompanyName + ""'>"" + row.CompanyName.substring(0, 10) + ""..."" + ""</a>"";
                            return title;
                  ");
                WriteLiteral(@"      }
                    },
                    ...
                    { data: ""Reg");
                WriteLiteral(@"isterMajor"", title: ""注册专业"",  searchable: true, orderable: true, width: ""100px"", responsivePriority: 1 },
        ...
        function Detail(Id) {
            ...
            var text = ""省份 : "" + (rows[0].Province == null ? ""无"" : rows[0].Province) + ""\n"";
  
            

            $(""#issueTableCodeContent"").ht");
                WriteLiteral(@"ml(text);
            ...
            editor = new $.fn.dataTable.Editor({
                        ...
                        ajax: {
                            edit: {
                                url: '");
                EndContext();
                BeginContext(14035, 39, false);
#line 282 "C:\Users\FS\source\repos\MyFirstProject\WF_WebProject\Views\ConstructorInfoes\Index.cshtml"
                                 Write(Url.Action("Edit", "ConstructorInfoes"));

#line default
#line hidden
                EndContext();
                BeginContext(14074, 957, true);
                WriteLiteral(@"',
                                type: 'POST',
                                dataType: 'json',
                                data: { ""Id"": rowId+'' }
