#pragma checksum "C:\Users\FS\source\repos\MyFirstProject\WF_WebProject\Views\ConstructorInfoes\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c0cb3aa6c1e08c47971bde9d3d3ca38848c78f47"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c0cb3aa6c1e08c47971bde9d3d3ca38848c78f47", @"/Views/ConstructorInfoes/Index.cshtml")]
 ...
 ");
           ...
           ");
                ...
                ajax: {
                    url: """);
                EndContext();
                BeginContext(9717, 43, false);
#line 207 "C:\Users\FS\source\repos\MyFirstProject\WF_WebProject\Views\ConstructorInfoes\Index.cshtml"
                     Write(Url.Action("PageData", "ConstructorInfoes"));

#line default
#line hidden
                EndContext();
                BeginContext(9760, 5277, true);
                WriteLiteral(@""",
                    type: ""post""
                },
                order: [[0, 'asc']],//一定要添加
                ...
                columns: [
                    ...
                    { data: ""Province"", title: ""省份"", searchable: true, orderable: false, visible: false, width: ""100px"", responsivePriority: 1 },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            var title = ""<a href='javascript:void(0);' onclick='Detail("" + meta.row + "")' title='"" + row.CompanyName + ""'>"" + row.CompanyName.substring(0, 8) + ""..."" + ""</a>"";
                            return title;
                   ");
                WriteLiteral(@"     }
                    },
                    ...
                    {
                        data: ""DateIssue"", title: ""发证日期"", searchable: true, orderable: true, width: ""100px"", respon");
                WriteLiteral(@"sivePriority: 1,
  ...
  ");
     ...
     ");
        ...
        function Detail(Id) {
            ...
            var text = ""省份 : "" + (rows[0].Province == null ? ""无"" : rows[0].Province) + ""</br>"";
        ...
        function initeditor() {
            editor = new $.fn.dataTable");
                WriteLiteral(".Editor({\r\n                        idSrc: \"Id\",\r\n                        ajax: {\r\n                            edit: {\r\n                                url: \'");
                EndContext();
                BeginContext(15038, 39, false);
#line 307 "C:\Users\FS\source\repos\MyFirstProject\WF_WebProject\Views\ConstructorInfoes\Index.cshtml"
                                 Write(Url.Action("Edit", "ConstructorInfoes"));

#line default
#line hidden
                EndContext();
                BeginContext(15077, 957, true);
                WriteLiteral(@"',
                                type: 'POST',
                                dataType: 'json',
                                data: { ""Id"": rowId+'' }
