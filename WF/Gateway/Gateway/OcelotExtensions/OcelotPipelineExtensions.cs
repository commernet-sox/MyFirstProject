...
namespace Gateway.OcelotExtensions
{
    ...
    {
        public static RequestDelegate BuildOcelotPipelineEx(this IApplicationBuilder app,
            OcelotPipelineConfigurationEx pipelineConfiguration)
        {
            ...
            pipelineConfiguration.Extend?.Invoke(app);
